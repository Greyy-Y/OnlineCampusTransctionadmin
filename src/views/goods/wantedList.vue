<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>求购商品列表</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 卡片视图 -->
    <el-card style="margin-top:20px">
      <!-- table表格区域 -->
      <el-table :data="goodslist" border stripe height="660">
        <el-table-column label="求购商品图片" width="">
        ...
        <el-table-column label="发布时间" prop="updatedAt" width="120px">
            ...
            >
              ...
              <div style="margin-bottom:20px;display:flex">
                ...
                <el-button
                  type="danger"
                  size="mini"
                  @click="delWanteds(scope.row._id)"
                  >删除</el-button
                >
              </div>
            </div>
...
export default {
  ...
  methods: {
    // 获取商品列表
    async getWantedsList() {
      const res = await GetWanteds();
      if (res.status !== 200) {
        return this.$message.error("获取求购商品列表失败");
      }
